	...
	<div class="c-media__body">
		<div class="p-archive-entry__body">
			...
			<div class="p-archive-entry__meta">
				<div class="p-archive-entry__datetime">公開日：<time datetime="<?php the_time( 'c' ); ?>"><?php the_time( get_option( 'date_format' ) ); ?></time></div>
				<div class="p-archive-entry__tags">タグ：<?php the_category( ', ' ); ?><?php the_tags( '', ', ' ); ?>
